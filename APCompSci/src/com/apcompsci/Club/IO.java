 ...
 * 
 * @author Nikhil Paranjape (indianpoptart - GitHub)
...
public class IO {
    public static void saveFile(String message){
        ...
        fc.setDialogTitle("Choose the directory where you want to save your binary file ");
    ...
    public static String openFile(){
        ...
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        JFileChooser fc = new JFileChooser();
        fc.setDialogTitle("Choose the directory you saved you bank file");
        fc.setFileSelectionMode(JFileChooser.FILES_ONLY);
